    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 selection:bg-[#ff5722]/20">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12 text-left">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          {/* REDES SOCIAIS EM CÍRCULOS PERFEITOS */}
          <div className="flex gap-4 mt-6">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer"
               className="w-10 h-10 bg-white/5 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#4267B2] transition-all duration-300 group">
